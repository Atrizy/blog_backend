...
## This is getting all the comments that are connected to a blog posting
def get_all_comments():
    ...
    try:
        ## This select statement is grabbing all the blog comments and joining the the users table to get the commenters user id
        cursor.execute(
